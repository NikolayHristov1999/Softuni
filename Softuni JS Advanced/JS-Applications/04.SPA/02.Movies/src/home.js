...
const catalog = document.querySelector('#movie .card-deck.d-flex')
section.remove();

section.querySelector('#createMovie').addEventListener('click', (event) => {
...
async function getMovies() {
    ...
    catalog.replaceChildren(...json.map(createCardMovie));
}
